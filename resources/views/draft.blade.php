    ...
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li><a class="nav-link scrollto font-green" href="#about">About</a></li>
          <li><a class="nav-link scrollto font-green" href="#services">News</a></li>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-lg-6 hero-img" data-aos="zoom-out" data-aos-delay="200">
          <img src="assets/img/logo-casturi.jpg" class="img-fluid" alt="">
        </div>
      </div>
    </div>
  ...
  <div class="row gy-1" data-aos="fade-left"  style="margin-bottom: 1000;">
    ...
    <div class="col-lg-5 col-md-6" data-aos="zoom-in" data-aos-delay="100" style="margin-right: auto; margin-left: auto">
      <div class="box">
        ...
        <a href="#" class="btn-buy" > <img src="assets/img/logo-shopee.png" alt="logo-shopee" width="30px" style="padding: 0px;">&nbsp Beli</a>
        <a href="#" class="btn-buy" > <img src="assets/img/logo-tokopedia.png" alt="logo-shopee" width="30px" style="padding: 0px;">&nbsp Beli</a>
      </div>
    </div>
...
<div class="container" data-aos="fade-up">
  ...
  <footer id="footer" class="footer">
    ...
    <div class="container">
      ...
      <div class="credits">
        <!-- All the links in the foot er should remain intact. -->
